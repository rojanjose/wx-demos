...
class WatsonDiscovery:
    ...
    def upload_document(self, collection_id, file_path, file_name, file_content_type, file_metadata = None):
        with open(file_path, 'rb') as file:
            add_document_response = self._discovery.add_document(
